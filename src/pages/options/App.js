...
import {HeaderSection, Section, Toggle, KeyCombo, Link, Info} from 'src/pages/components/settings'
...
class App extends Component {
	...
	componentDidMount() {
		...
		chrome.runtime.sendMessage('siteList', function(siteList) {
			...
			<div className={styles.pageContainer}>
				<div className={styles.pageContent}>
					...
					<Section title="Settings for all sites">
						<Toggle key="globalStaticCaptions"
						...
						<Toggle key="globalTextboxExpansion"
						...
						<Toggle key="globalAutoSaveProgress"
